...
class ApprovalJob(Base):
    ...
    state: Mapped[JobState] = mapped_column(Enum(JobState, name="job_state"), default=JobState.PENDING)
...
class AuditLog(Base):
    ...
    event_type: Mapped[AuditEventType] = mapped_column(Enum(AuditEventType, name="audit_event"), nullable=False)
