...
class Rule(Base):
    ...
    model: Mapped[ApprovalModel] = mapped_column(Enum(ApprovalModel, name="approval_model"), nullable=False)
    k_value: Mapped[int | None] = mapped_column(Integer, nullable=True)
    timeout_seconds: Mapped[int] = mapped_column(Integer, default=300)
    on_timeout: Mapped[TimeoutAction] = mapped_column(Enum(TimeoutAction, name="timeout_action"), default=TimeoutAction.BLOCK)
