    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 focus:ring-zinc-500": variant === "default",
            ...
            "hover:bg-zinc-100 dark:hover:bg-zinc-800 dark:text-zinc-100 focus:ring-zinc-500": variant === "ghost",
